// ── Vimeo /api/vimeo/download ─────────────────────────────────────────────────
// Vimeo has multiple quality levels — we can target by height
...
const EXTRA = ['--referer', 'https://vimeo.com/'];

const FORMAT_MAP = {
  mp4: {
    high:   'bestvideo[ext=mp4][height<=1080]+bestaudio[ext=m4a]/bestvideo[ext=mp4]+bestaudio/best[ext=mp4]/best',
    medium: 'bestvideo[ext=mp4][height<=720]+bestaudio[ext=m4a]/best[height<=720][ext=mp4]/best',
    low:    'bestvideo[ext=mp4][height<=480]+bestaudio[ext=m4a]/worst[ext=mp4]/worst',
  },
  mp3: {
    high:   'bestaudio/best',
